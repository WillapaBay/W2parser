...
public class TestDistributedTributaryConstituentsCard {
    ...
    private void unitTest(String folder) throws IOException {
        ...
        DistributedTributaryConstituentsCard card = new DistributedTributaryConstituentsCard(w2con, numConstituents, NWB);
    }
