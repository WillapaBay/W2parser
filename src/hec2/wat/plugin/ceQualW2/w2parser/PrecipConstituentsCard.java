...
/**
 * Precipitation Constituents Card
 *
 ...
 */
public class PrecipConstituentsCard extends W2Card {

    public PrecipConstituentsCard(W2ControlFile w2ControlFile, int numConstituents, int numBranches) {
        super(w2ControlFile,"CPR CON", numConstituents,
