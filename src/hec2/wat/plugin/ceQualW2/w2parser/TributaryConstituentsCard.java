 ...
 */
public class TributaryConstituentsCard extends W2Card {

    public TributaryConstituentsCard(W2ControlFile w2ControlFile, int numConstituents, int numTributaries) {
        super(w2ControlFile,"CTR CON", numConstituents,
                W2Globals.constants(numConstituents, numTributaries),
                8, false);
        parseTable();
    }
