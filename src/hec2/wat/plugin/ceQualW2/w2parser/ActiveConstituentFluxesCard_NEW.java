 ...
 */
public class ActiveConstituentFluxesCard_NEW extends W2Card_NEW {

    public ActiveConstituentFluxesCard_NEW(W2ControlFile w2ControlFile, int numFluxes, int numWaterBodies) {
